...
def create_model_and_diffusion(
    ...
    diffusion = create_gaussian_diffusion(
        ...
        predict_previousx=predict_previousx,
...
def create_model(
    ...
    return UNetModel(
        ...
        in_channels=(num_channels if not class_cond else 6),
        model_channels=num_channels,
        out_channels=(num_channels if not learn_sigma else 6),
    ...
    *,
    ...
    return SpacedDiffusion(
        ...
        model_mean_type=(
            ...
            if not predict_previousx
            else gd.ModelMeanType.PREVIOUS_X
...
def adjust_scales2mc(real, args, opt):
    ...
    opt.stop_scale = len(scales) + 1
    opt.scale_info = scales 

    args.num_scales = opt.num_scales
    args.scale1 = scales[-1] 
    args.stop_scale = opt.stop_scale
    args.scale_factor = None 
